...
function Projects() {
  const product = [
    { title: "RahulGemi", desc: "AI-powered chat assistant built with React and Gemini API for smart conversations and task suggestions.", live: true, case:true, liveLink: "https://rahul-gemi.vercel.app/", caseLink: "https://github.com/Rahulgupta7070/RahulGemini" },
    { title: "SnipDoWeb", desc: "SnipDoWeb is a React.js-based creative agency project showcasing skills in Web Design, UI/UX, Branding, Graphic & Video Editing. Offers complete digital services with clean design and smooth interactions for service-based websites.", live: true, case:true, liveLink: "https://snipdoweb.vercel.app/", caseLink: "https://github.com/Rahulgupta7070/SnipDoWeb" },
    ...
    { title: "Simon Says Game", desc: "A fun and interactive Simon Says Game built using HTML, CSS, and JavaScript. Players test their memory by following and repeating the flashing color patterns. The sequence gets longer with each round, increasing the challenge level.", live: true, case: true, liveLink: "https://example.com/hospital", caseLink: "https://github.com/Rahulgupta7070/Simon-Says-Game" },
    ...
    { title: "Rahul Portfolio", desc: "Developed a dynamic and responsive personal portfolio website using HTML, CSS, and JavaScript, showcasing my skills, projects, and achievements. The website features smooth animations and interactive elements, providing an engaging user experience", live: true, case: true, liveLink: "https://portfoliogupta.vercel.app/", caseLink: "https://github.com/Rahulgupta7070/portfolio" },
  ...
  const images = [
    "https://tldv.io/wp-content/uploads/2025/01/Gemini-Alternatives.jpg",
    "/snipdoweblogo.png",
    "/CarShowRoom.png",
    "/Hospital.png",
